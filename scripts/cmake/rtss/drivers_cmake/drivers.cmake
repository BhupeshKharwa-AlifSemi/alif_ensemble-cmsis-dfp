...
target_sources(${DRIVER_LIB} PRIVATE
    ...
    $<$<BOOL:${ENABLE_CDC200}>:${ALIF_CMSIS_DRIVER_SRC_DIR}/DPHY_Common.c>
    ...
    #S80K Hyper RAM XIP Driver
    $<$<BOOL:${ENABLE_S80K_XIP_HYPERRAM}>:${ALIF_COMPONENTS_SRC_DIR}/S80K_HyperRAM.c>
    ...
    #Camera Driver
    $<$<BOOL:${ENABLE_CAMERA}>:${ALIF_CMSIS_DRIVER_SRC_DIR}/Camera_Sensor_i2c.c>

    #Camera MT9M114 Driver
    $<$<BOOL:${ENABLE_ARX3A0_CAMERA}>:${ALIF_COMPONENTS_SRC_DIR}/MT9M114_Camera_Sensor.c>
