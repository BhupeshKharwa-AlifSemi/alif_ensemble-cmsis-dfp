...
macro (BUILD_PROJECT)
    ...
    elseif (OS STREQUAL NONE)
        ...
        # Linking all the library files to the test application
        target_link_libraries(${EXECUTABLE} ${COMMON_LIB} ${DRIVER_LIB} ${SE_HOST_SERVICES_LIB} ${OS_LIB_FILE})
    ...
    IF (EXISTS "$ENV{SE_TOOLS}/build/images")
        add_custom_command(TARGET  ${EXECUTABLE}
            POST_BUILD
            COMMAND  cp "${OUTPUT_DIR}/${EXECUTABLE}.bin" "$ENV{SE_TOOLS}/build/images/${CPU}_${RTSS}.bin"
            COMMAND  echo "Copied binary ${Green}${CPU}_${RTSS}.bin ${ColourReset} to $ENV{SE_TOOLS}/build/images/"
    )
    endif ()
