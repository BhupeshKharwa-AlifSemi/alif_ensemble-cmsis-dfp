...
typedef struct {                                /*!< (@ 0x48100000) ETH Structure                                              */
  ...
  __IM  uint32_t  ETH_DMA_CH0_RX_ERI_CNT;       /*!< (@ 0x00001168) DMA Channel 0 Receive ERI Counter Register                 */
...
typedef struct {                                /*!< (@ 0x49034000) I3C Structure                                              */
  ...
  __IOM uint32_t  I3C_DEV_ADDR_TABLE_LOC1;      /*!< (@ 0x00000220) Device Address Table Location 1 Register                   */
