 ...
 *
 * @file     AE402FA0E5597LS0_CM55_HE_View.h
 * @brief    CMSIS HeaderFile
 * @version  1.0
 * @date     31. January 2025
 * @note     Generated by SVDConv V3.3.42 on Friday, 31.01.2025 22:20:32
 *           from File 'AE402FA0E5597LS0_CM55_HE_View.svd',
...
/** @addtogroup AE402FA0E5597LS0_CM55_HE_View
 * @{
 */

#ifndef AE402FA0E5597LS0_CM55_HE_VIEW_H
#define AE402FA0E5597LS0_CM55_HE_VIEW_H
...
typedef enum {
    ...
    /* ================================  AE402FA0E5597LS0_CM55_HE_View Specific Interrupt Numbers
     * ================================ */
...
typedef struct { /*!< (@ 0x1A602000) CGU Structure                                              */
    ...
    __IOM uint32_t SHMEM_CLK_CTRL; /*!< (@ 0x00000028) Shared Memory Clock Controllers Control
                                      Register           */
...
typedef struct { /*!< (@ 0x400E1000) NPU_HE Structure                                           */
    ...
    __IOM uint32_t NPUHE_PMCNTENSET; /*!< (@ 0x00000184) Performance Monitor Count Enable Set
                                        Register              */
    __IOM uint32_t NPUHE_PMCNTENCLR; /*!< (@ 0x00000188) Performance Monitor Count Enable Clear
                                        Register            */
    __IOM uint32_t NPUHE_PMOVSSET;   /*!< (@ 0x0000018C) Performance Monitor Overflow Status Set
                                        Register           */
    __IOM uint32_t NPUHE_PMOVSCLR;   /*!< (@ 0x00000190) Performance Monitor Overflow Status Clear
                                        Register         */
    ...
    __IOM uint32_t NPUHE_PMINTCLR; /*!< (@ 0x00000198) Performance Monitor Interrupt Clear Register
                                    */
    __IM uint32_t  RESERVED3;
    __IOM uint32_t NPUHE_PMCCNTR_LO; /*!< (@ 0x000001A0) Performance Monitor Cycle Count Low
                                        Register               */
    __IOM uint32_t NPUHE_PMCCNTR_HI; /*!< (@ 0x000001A4) Performance Monitor Cycle Count High
                                        Register              */
    __IM uint32_t  RESERVED4;
    __IOM uint32_t NPUHE_PMCAXI_CHAN; /*!< (@ 0x000001AC) Performance Monitor AXI Channel Select
                                         Register            */
...
typedef struct { /*!< (@ 0x42002000) LPGPIO Structure                                           */
    ...
    __OM uint32_t  GPIO_BIT_MAN_CTRL_W1C; /*!< (@ 0x00000104) Bit Manipulation Control Register -
                                             Write 1 to  Clear  */
    __OM uint32_t GPIO_BIT_MAN_CTRL_W1F;  /*!< (@ 0x00000108) Bit Manipulation Control Register -
                                             Write 1 to  Toggle  */
    __OM uint32_t GPIO_BIT_MAN_CTRL_W1S;  /*!< (@ 0x0000010C) Bit Manipulation Control Register -
                                             Write 1 to  Set  */
...
typedef struct { /*!< (@ 0x43003000) LPCPI Structure                                            */
    ...
    __IOM uint32_t CAM_FRAME_ADDRB; /*!< (@ 0x00000034) Camera Sequential Video Frame Start Address
                                       B Register */
    __IOM uint32_t CAM_FRAME_ADDRC; /*!< (@ 0x00000038) Camera Sequential Video Frame Start Address
                                       C Register */
    __IOM uint32_t CAM_FRAME_ADDRD; /*!< (@ 0x0000003C) Camera Sequential Video Frame Start Address
                                       D Register */
...
typedef struct { /*!< (@ 0x48100000) ETH Structure                                              */
    ...
    union {
        __IOM uint32_t ETH_RWK_PACKET_FILTER;    /*!< (@ 0x000000C4) Remote Wakeup Filter Byte Mask
                                                    Register                    */
    ...
    __IOM uint32_t ETH_MAC_RX_DOMAIN_TIME_INCR; /*!< (@ 0x00000B24) Rx Domain Time Increment
                                                   Register                          */
    __IOM uint32_t ETH_MAC_TX_DOMAIN_TIME_INCR; /*!< (@ 0x00000B28) Tx Domain Time Increment
                                                   Register                          */
    ...
    __IOM uint32_t ETH_AXI4_TX_AR_ACE_CONTROL;     /*!< (@ 0x00001020) AXI4 TX DMA Read ACE Control
                                                      Register                      */
    __IOM uint32_t ETH_AXI4_RX_AW_ACE_CONTROL;     /*!< (@ 0x00001024) AXI4 RX DMA Write ACE Control
                                                      Register                     */
    __IOM uint32_t ETH_AXI4_TXRX_AWAR_ACE_CONTROL; /*!< (@ 0x00001028) AXI4 TX/RX DMA Read/Write ACE
                                                      Control Register            */
...
typedef struct { /*!< (@ 0x43006000) LPI3C Structure                                            */
    ...
    __IM uint32_t I3C_DEV_CHAR_TABLE1_LOC4; /*!< (@ 0x0000020C) Device Characteristic Table Location
                                               4 Register            */
    __IM uint32_t  RESERVED6[28];
    __IOM uint32_t I3C_DEV_ADDR_TABLE_LOC1; /*!< (@ 0x00000280) Device Address Table Location 1
                                               Register                   */
...
#endif /* AE402FA0E5597LS0_CM55_HE_VIEW_H */

/** @} */ /* End of group AE402FA0E5597LS0_CM55_HE_View */
