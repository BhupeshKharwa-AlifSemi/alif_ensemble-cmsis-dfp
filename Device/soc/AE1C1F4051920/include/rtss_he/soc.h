 ...
 *
 * @file     AE1C1F4051920PH_CM55_HE_View.h
 * @brief    CMSIS HeaderFile
 * @version  1.0
 * @date     20. December 2024
 * @note     Generated by SVDConv V3.3.42 on Friday, 20.12.2024 18:40:20
 *           from File 'AE1C1F4051920PH_CM55_HE_View.svd',
 *           last modified on Friday, 20.12.2024 16:34:15
 */
...
/** @addtogroup AE1C1F4051920PH_CM55_HE_View
  * @{
  */


  #ifndef AE1C1F4051920PH_CM55_HE_VIEW_H
  #define AE1C1F4051920PH_CM55_HE_VIEW_H
  ...
  /* ================================  AE1C1F4051920PH_CM55_HE_View Specific Interrupt Numbers  ================================ */
    ...
    LPRTC1_IRQ_IRQn           =  59,              /*!< 59 Interrupt                                                              */
    LPTIMER0_IRQ_IRQn         =  60,              /*!< 346  LPTIMER0 interrupt request                                           */
    LPTIMER1_IRQ_IRQn         =  61,              /*!< 347  LPTIMER1 interrupt request                                           */
    ...
    CANFD1_IRQ_IRQn           = 105,              /*!< 105  CANFD1 Interrupt request                                             */
...
/* ========================================  Start of section using anonymous unions  ======================================== */
  ...
  /**
    * @brief MHU_SECPU_M55HE_0_RX_MHU_RX_CHANNEL_CFG [MHU_RX_CHANNEL_CFG] ([0..1])
    */
  typedef struct {
  ...
  } MHU_SECPU_M55HE_0_RX_MHU_RX_CHANNEL_CFG_Type; /*!< Size = 32 (0x20)                                                          */


  /**
    * @brief MHU_M55HE_SECPU_0_TX_MHU_TX_CHANNEL_CFG [MHU_TX_CHANNEL_CFG] ([0..1])
    */
  typedef struct {
    __IM  uint32_t  MHU_CH_ST;                    /*!< (@ 0x00000000) Channel (n) Status Register                                */
    ...
    __IM  uint32_t  RESERVED1;
  } MHU_M55HE_SECPU_0_TX_MHU_TX_CHANNEL_CFG_Type; /*!< Size = 32 (0x20)                                                          */
  ...
  typedef struct {                                /*!< (@ 0x1A604000) AON Structure                                              */
    ...
    __IOM uint32_t  RTSS_HE_CHICKEN;              /*!< (@ 0x00000018) M55-HE Clocks Override Register                            */
  ...
  typedef struct {                                /*!< (@ 0x1A609000) VBAT Structure                                             */
    ...
    __IOM uint32_t  RTCA_CLK_EN;                  /*!< (@ 0x00000010) LPRTC A Clock Enable Register                              */
    __IOM uint32_t  RTCB_CLK_EN;                  /*!< (@ 0x00000014) LPRTC B Clock Enable Register                              */
  } VBAT_Type;                                    /*!< Size = 24 (0x18)                                                          */
  ...
  /* =========================================================================================================================== */
  /* ================                                    MHU_SECPU_M55HE_0_RX                                  ================ */
  /* =========================================================================================================================== */
  
  typedef struct {                                /*!< (@ 0x40040000) MHU_SECPU_M55HE_0_RX Structure                             */
    __IOM MHU_SECPU_M55HE_0_RX_MHU_RX_CHANNEL_CFG_Type MHU_RX_CHANNEL_CFG[2];/*!< (@ 0x00000000) [0..1]                          */
  ...
  } MHU_SECPU_M55HE_RX_Type;                      /*!< Size = 4096 (0x1000)                                                      */



  /* =========================================================================================================================== */
  /* ================                                   MHU_M55HE_SECPU_0_TX                                    ================ */
  /* =========================================================================================================================== */


  /**
    * @brief MHU_M55HE_SECPU_0_TX (MHU_M55HE_SECPU_0_TX)
    */

  typedef struct {                                /*!< (@ 0x40050000) MHU_M55HE_SECPU_0_TX Structure                             */
    __IOM MHU_M55HE_SECPU_0_TX_MHU_TX_CHANNEL_CFG_Type MHU_TX_CHANNEL_CFG[2];/*!< (@ 0x00000000) [0..1]                          */
    __IM  uint32_t  RESERVED[976];
    ...
    __IM  uint32_t  MHU_CID2;                     /*!< (@ 0x00000FF8) Component ID 2 Register                                    */
    __IM  uint32_t  MHU_CID3;                     /*!< (@ 0x00000FFC) Component ID 3 Register                                    */
  } MHU_M55HE_SECPU_TX_Type;                      /*!< Size = 4096 (0x1000)                                                      */
  ...
  typedef struct {                                /*!< (@ 0x42001000) LPTIMER Structure                                          */
    __IOM LPTIMER_LPTIMER_CHANNEL_CFG_Type LPTIMER_CHANNEL_CFG[2];/*!< (@ 0x00000000) [0..1]                                     */
    ...
    __IOM uint32_t  LPTIMER_LOADCOUNT2[2];        /*!< (@ 0x000000B0) Timer (n) Load Count2 Register                             */
  } LPTIMER_Type;                                 /*!< Size = 184 (0xb8)                                                         */
  ...
  typedef struct {                                /*!< (@ 0x42007000) LPGPIO_CTRL Structure                                      */
    __IOM uint32_t  LPGPIO_CTRL_[2];              /*!< (@ 0x00000000) LPGPIO I/O Buffer Control Register                         */
  } LPGPIO_CTRL_Type;                             /*!< Size = 8 (0x8)                                                            */
  ...
  typedef struct {                                /*!< (@ 0x43007000) M55HE_CFG Structure                                        */
    ...
    __IOM uint32_t  HE_FLT_ENA0;                  /*!< (@ 0x00000024) Filter Enable 0 Register                                   */
    __IOM uint32_t  HE_FLT_ENA1;                  /*!< (@ 0x00000028) Filter Enable 1 and LPCPI Control Register                 */
  } M55HE_CFG_Type;                               /*!< Size = 44 (0x2c)                                                          */
  ...
  typedef struct {                                /*!< (@ 0x48000000) UTIMER Structure                                           */
    ...
    __IOM UTIMER_UTIMER_CHANNEL_CFG_Type UTIMER_CHANNEL_CFG[4];/*!< (@ 0x00001000) [0..3]                                        */
  } UTIMER_Type;                                  /*!< Size = 20480 (0x5000)                                                     */
  ...
  typedef struct {                                /*!< (@ 0x4902F000) CLKCTL_PER_SLV Structure                                   */
    ...
    __IOM uint32_t  I2S_CTRL[2];                  /*!< (@ 0x00000010) I2Sn Control Register                                      */
    __IM  uint32_t  RESERVED1[3];
    ...
    __IOM uint32_t  GPIO_CTRL[10];                /*!< (@ 0x00000080) GPIOn Control Register                                     */
  } CLKCTL_PER_SLV_Type;                          /*!< Size = 168 (0xa8)                                                         */
  ...
  #define REFCLK_CNT_READ_BASE        0x1A210000UL
  ...
  #define S32KCLK_CNT_READ_BASE       0x1A410000UL
  ...
  #define LPRTC1_BASE                 0x42003000UL
  ...
  /** @addtogroup Device_Peripheral_declaration
    ...
    */
    ...
    #define MHU_SECPU_M55HE_0_RX        ((MHU_SECPU_M55HE_RX_Type*)    MHU_SECPU_M55HE_0_RX_BASE)
    #define MHU_M55HE_SECPU_0_TX        ((MHU_M55HE_SECPU_TX_Type*)    MHU_M55HE_SECPU_0_TX_BASE)
    #define MHU_SECPU_M55HE_1_RX        ((MHU_SECPU_M55HE_RX_Type*)    MHU_SECPU_M55HE_1_RX_BASE)
    #define MHU_M55HE_SECPU_1_TX        ((MHU_M55HE_SECPU_TX_Type*)    MHU_M55HE_SECPU_1_TX_BASE)
    ...
    #define LPRTC1                      ((LPRTC_Type*)             LPRTC1_BASE)
    ...
    #define CANFD1                      ((CANFD_Type*)             CANFD1_BASE)
    #define CANFD1_CNT                  ((CAN_CNT_Type*)           CANFD1_CNT_BASE)
  ...
  #endif /* AE1C1F4051920PH_CM55_HE_VIEW_H */
  
  
  /** @} */ /* End of group AE1C1F4051920PH_CM55_HE_View */
