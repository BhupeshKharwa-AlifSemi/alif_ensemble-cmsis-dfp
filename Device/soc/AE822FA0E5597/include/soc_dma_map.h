...
#define LPUT0_DMA                   2
#define LPUT0_DMA_T0_PERIPH_REQ     0
#define LPUT0_DMA_T1_PERIPH_REQ     1
#define LPUT0_DMA_GROUP             1
#define LPUT0_DMA_HANDSHAKE_ENABLE  0

#define LPUT0_DMA                   2
#define LPUT1_DMA_T0_PERIPH_REQ     2
#define LPUT1_DMA_T1_PERIPH_REQ     3
#define LPUT0_DMA_GROUP             1
#define LPUT0_DMA_HANDSHAKE_ENABLE  0
...
#if RTE_GPIO8
#define GPIO8_DMA_GLITCH_FILTER                                                                    \
    ((RTE_GPIO8_PIN0_DMA_GLITCH_FILTER_ENABLE << 24) |                                             \
...
#if RTE_GPIO9
#define GPIO9_DMA_GLITCH_FILTER                                                                    \
    ((RTE_GPIO9_PIN0_DMA_GLITCH_FILTER_ENABLE << 0) |                                              \
...
#else
#define GPIO9_DMA_GLITCH_FILTER 0
#endif

#if RTE_LPGPIO
#define LPGPIO_DMA_GLITCH_FILTER                                                                   \
    ((RTE_LPGPIO_PIN0_DMA_GLITCH_FILTER_ENABLE << 0) |                                             \
...
#define DMA0_GLITCH_FILTER                                                                         \
    (GPIO3_DMA_GLITCH_FILTER | GPIO4_DMA_GLITCH_FILTER | GPIO7_DMA_GLITCH_FILTER |                 \
     GPIO8_DMA_GLITCH_FILTER)

#if (RTE_DMA1)
#define DMALOCAL_GLITCH_FILTER (GPIO9_DMA_GLITCH_FILTER)
#elif (RTE_DMA2)
#define DMALOCAL_GLITCH_FILTER (LPGPIO_DMA_GLITCH_FILTER)
#endif
