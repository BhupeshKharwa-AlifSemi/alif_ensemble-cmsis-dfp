 ...
 *           I2C0 instance is taken as Slave  (PIN used P7_0 and P7_1)
 *
 *           Hardware setup:
...
static void hardware_init(void)
{
    ...
    /* I2C1_SDA_C */
    pinconf_set(PORT_7, PIN_2, PINMUX_ALTERNATE_FUNCTION_4,
                (PADCTRL_READ_ENABLE));

    /* I2C1_SCL_C */
    pinconf_set(PORT_7, PIN_3, PINMUX_ALTERNATE_FUNCTION_4,
                (PADCTRL_READ_ENABLE));
}
