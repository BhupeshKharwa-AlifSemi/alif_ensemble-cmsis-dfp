...
static int32_t pinmux_config(void)
{
    ...
    /* CANFD0_Rx_C */
    ret_val = pinconf_set(PORT_8, PIN_2, PINMUX_ALTERNATE_FUNCTION_7,
                         (PADCTRL_READ_ENABLE |
    ...
    /* CANFD0_Tx_C */
    ret_val = pinconf_set(PORT_8, PIN_3, PINMUX_ALTERNATE_FUNCTION_6,
                          PADCTRL_OUTPUT_DRIVE_STRENGTH_2MA);
    if(ret_val)
    {
    ...
    /* CANFD0_Stby_C */
    ret_val = pinconf_set(PORT_8, PIN_4, PINMUX_ALTERNATE_FUNCTION_6,
                          PADCTRL_OUTPUT_DRIVE_STRENGTH_2MA);
    if(ret_val)
    {
