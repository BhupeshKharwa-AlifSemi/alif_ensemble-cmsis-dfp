 ...
 *
 *           hardware setup
 *           BMI Slave is internally connected with the I3C_A
...
{
    /* I3C_SDA_A */
    pinconf_set(PORT_0, PIN_6, PINMUX_ALTERNATE_FUNCTION_5,
                PADCTRL_READ_ENABLE | PADCTRL_DRIVER_DISABLED_PULL_UP |
                PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA);

    /* I3C_SCL_A */
    pinconf_set(PORT_0, PIN_5, PINMUX_ALTERNATE_FUNCTION_5,
                PADCTRL_READ_ENABLE | PADCTRL_DRIVER_DISABLED_PULL_UP |
                PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA);
