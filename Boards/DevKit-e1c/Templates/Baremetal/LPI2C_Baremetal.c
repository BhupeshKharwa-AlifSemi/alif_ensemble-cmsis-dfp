 ...
 *
 *           Hardware Connection:
 *           I2C0 SDA(P7_0) -> LPI2C SDA(P0_1)
 *           I2C0 SCL(P7_1) -> LPI2C SCL(P0_0)
 ******************************************************************************/
...
{
    /* LPI2C_SCL_A */
    pinconf_set(PORT_0, PIN_0, PINMUX_ALTERNATE_FUNCTION_5,
                (PADCTRL_READ_ENABLE                      |
                 PADCTRL_DRIVER_DISABLED_PULL_UP          |
                 PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA));

    /* LPI2C_SDA_A */
    pinconf_set(PORT_0, PIN_1, PINMUX_ALTERNATE_FUNCTION_5,
                (PADCTRL_READ_ENABLE                      |
                 PADCTRL_DRIVER_DISABLED_PULL_UP          |
                 PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA));

    /* I2C0_SDA_C */
    pinconf_set(PORT_7, PIN_0, PINMUX_ALTERNATE_FUNCTION_4,
                (PADCTRL_READ_ENABLE                      |
                 PADCTRL_DRIVER_DISABLED_PULL_UP          |
                 PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA));

    /* I2C0_SCL_C */
    pinconf_set(PORT_7, PIN_1, PINMUX_ALTERNATE_FUNCTION_4,
                (PADCTRL_READ_ENABLE                      |
                 PADCTRL_DRIVER_DISABLED_PULL_UP          |
                 PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA));
}
