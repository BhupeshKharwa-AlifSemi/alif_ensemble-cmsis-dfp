...
const struct pinconf board_pinconf[] = {
    ...
    {PORT_0, PIN_2, PINMUX_ALTERNATE_FUNCTION_3, PADCTRL_READ_ENABLE | PADCTRL_DRIVER_DISABLED_PULL_UP},
    ...
    {PORT_0, PIN_3, PINMUX_ALTERNATE_FUNCTION_3, PADCTRL_DRIVER_DISABLED_BUS_REPEATER | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
