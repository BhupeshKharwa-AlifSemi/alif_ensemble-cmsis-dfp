...
#define USB_SET_CONFIG_REQ                        0x09
#define USB_SET_CTRL_LINE_STATE                   0x22
...
/*
 * return Physical EP number as controller mapping
 */
...
#define USB_GET_EP_EVENT_STATUS(reg)                                                               \
    ((reg & USB_EVT_EPSTATUS_MSK) >> USB_EVT_EPSTATUS_POS)
...
#define USB_DGCMD_STATUS(n)                                                                        \
    (((n) & USB_DGCMD_STATUS_MSK) >> USB_DGCMD_STATUS_POS)
...
#define USB_TRB_CTRL_TRBCTL(n)         (((n) & USB_TRB_CTRL_TRBCTL_MSK) << USB_TRB_CTRL_TRBCTL_POS)
...
#define USB_TRB_SIZE_TRBSTS(n)         (((n) & USB_TRB_SIZE_TRBSTS_MSK) >> USB_TRB_SIZE_TRBSTS_POS)
...
/* Define USB device event configuration config values */
...
/* Define USB physical endpoint structure.  */
...
typedef enum _USB_DEVICE_STATE {
    ...
    USBD_STATE_ATTACHED,
    USBD_STATE_POWERED,         /* wired */
    USBD_STATE_RECONNECTING,    /* auth */
    USBD_STATE_UNAUTHENTICATED, /* auth */
    USBD_STATE_DEFAULT,         /* limited function */
    USBD_STATE_ADDRESS,
    USBD_STATE_CONFIGURED, /* most functions */
...
typedef struct _USB_DRIVER {
    ...
    USBD_TRB                     endp0_trb ATTR_ALIGN(32);
