...
static inline void aes_set_signal_delay(AES_Type *aes, uint8_t delay)
{
    ...
    aes->AES_RXD_DELAY_2 = ((delay << AES_SIGNAL_8_DELAY_POS) | (delay << AES_SIGNAL_9_DELAY_POS) |
                            (delay << AES_SIGNAL_10_DELAY_POS) | (delay << AES_SIGNAL_11_DELAY_POS));
    aes->AES_RXD_DELAY_3 = ((delay << AES_SIGNAL_12_DELAY_POS) | (delay << AES_SIGNAL_13_DELAY_POS) |
    ...
    aes->AES_TXD_DELAY_1 = ((delay << AES_SIGNAL_4_DELAY_POS) | (delay << AES_SIGNAL_5_DELAY_POS) |
                            (delay << AES_SIGNAL_6_DELAY_POS) | (delay << AES_SIGNAL_7_DELAY_POS));
    aes->AES_TXD_DELAY_2 = ((delay << AES_SIGNAL_8_DELAY_POS) | (delay << AES_SIGNAL_9_DELAY_POS) |
                            (delay << AES_SIGNAL_10_DELAY_POS) | (delay << AES_SIGNAL_11_DELAY_POS));
    aes->AES_TXD_DELAY_3 = ((delay << AES_SIGNAL_12_DELAY_POS) | (delay << AES_SIGNAL_13_DELAY_POS) |
                            (delay << AES_SIGNAL_14_DELAY_POS) | (delay << AES_SIGNAL_15_DELAY_POS));

    aes->AES_SSI_OE_N_DELAY_0 = ((delay << AES_SIGNAL_0_DELAY_POS) | (delay << AES_SIGNAL_1_DELAY_POS) |
                                 (delay << AES_SIGNAL_2_DELAY_POS) | (delay << AES_SIGNAL_3_DELAY_POS));
    aes->AES_SSI_OE_N_DELAY_1 = ((delay << AES_SIGNAL_4_DELAY_POS) | (delay << AES_SIGNAL_5_DELAY_POS) |
                                 (delay << AES_SIGNAL_6_DELAY_POS) | (delay << AES_SIGNAL_7_DELAY_POS));
    aes->AES_SSI_OE_N_DELAY_2 = ((delay << AES_SIGNAL_8_DELAY_POS) | (delay << AES_SIGNAL_9_DELAY_POS) |
                                 (delay << AES_SIGNAL_10_DELAY_POS) | (delay << AES_SIGNAL_11_DELAY_POS));
    aes->AES_SSI_OE_N_DELAY_3 = ((delay << AES_SIGNAL_12_DELAY_POS) | (delay << AES_SIGNAL_13_DELAY_POS) |
                                 (delay << AES_SIGNAL_14_DELAY_POS) | (delay << AES_SIGNAL_15_DELAY_POS));

    aes->AES_SS_N_DELAY = ((delay << AES_SIGNAL_0_DELAY_POS) | (delay << AES_SIGNAL_1_DELAY_POS));

    aes->AES_TXD_DM_DELAY = ((delay << AES_TXD_DM_0_DELAY_POS) | (delay << AES_TXD_DM_1_DELAY_POS) |
