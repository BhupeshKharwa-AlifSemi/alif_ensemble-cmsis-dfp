...
typedef enum {
    ...
    /* HFRC frequencies in ACTIVE mode */ /**< SCALED_FREQ_RC_ACTIVE_76_8_MHZ */
    ...
    /* HFRC frequencies in STANDBY mode */ /**< SCALED_FREQ_RC_STDBY_76_8_MHZ */
    ...
    /* HFXO frequencies using the LOW divider */ /**< SCALED_FREQ_XO_LOW_DIV_38_4_MHZ */
    ...
    /* HFXO frequencies using the HIGH divider */ /**< SCALED_FREQ_XO_HIGH_DIV_38_4_MHZ */
 ...
 */
typedef enum {
    IP_CLOCK_NPU_HP,   /**< NPU_HP */
    IP_CLOCK_NPU_HE,   /**< NPU_HE */
    IP_CLOCK_ISIM,     /**< ISIM */
    IP_CLOCK_OSPI_1,   /**< OSPI_1 */
    IP_CLOCK_CANFD,    /**< CANFD */
    IP_CLOCK_SDC,      /**< SDC */
    IP_CLOCK_USB,      /**< USB */
    IP_CLOCK_ETH,      /**< ETH */
    IP_CLOCK_GPU,      /**< GPU */
    IP_CLOCK_CDC200,   /**< CDC200 */
    IP_CLOCK_CAMERA,   /**< CAMERA */
    IP_CLOCK_MIPI_DSI, /**< MIPI_DSI */
    IP_CLOCK_MIPI_CSI, /**< MIPI_CSI */
    IP_CLOCK_LP_PERIPH /**< LP_PERIPH */
} ip_clock_gating_t;
