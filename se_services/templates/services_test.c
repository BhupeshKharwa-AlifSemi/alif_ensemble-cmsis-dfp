...
#if ((DEVICE_TYPE == FUSION && DEVICE_REVISION == REV_B0) || (DEVICE_TYPE == SPARK))
    error_code = SERVICES_pinmux(services_handle, 1, 4, 1, &service_error_code);
#else
    /* configures blinky */
    error_code = SERVICES_pinmux(services_handle, 1, 14, 0, &service_error_code);
#endif
...
#if ((DEVICE_TYPE == FUSION && DEVICE_REVISION == REV_B0) || (DEVICE_TYPE == SPARK))
    error_code = SERVICES_padcontrol(services_handle, 1, 4, 0x23, &service_error_code);
#else
    /* configures blinky */
    error_code = SERVICES_padcontrol(services_handle, 1, 14, 0x0, &service_error_code);
#endif
...
static uint32_t test_services_crypto_trng64(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code =
        SERVICES_cryptocell_get_rnd(services_handle,
...
static uint32_t test_services_crypto_lcs(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code = SERVICES_cryptocell_get_lcs(services_handle, &lcs_state, &service_error_code);
    TEST_print(services_handle,
               "** TEST %s error_code=%s service_resp=0x%08X\n",
               p_test_name,
               SERVICES_error_to_string(error_code),
...
static uint32_t test_services_read_otp_illegal(char *p_test_name, uint32_t services_handle)
{
     ...
     */
    error_code = SERVICES_system_read_otp(services_handle, 0x00, &otp_value, &service_error_code);
    PRINT_TEST_RESULT;
...
static uint32_t test_services_gettoc(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code =
        SERVICES_system_get_toc_number(services_handle, &number_of_tocs, &service_error_code);
    TEST_print(services_handle,
...
static uint32_t test_services_gettoc_data(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code = SERVICES_system_get_toc_data(services_handle, NULL, &service_error_code);
    TEST_print(services_handle,
    ...
    error_code = SERVICES_system_get_toc_data(services_handle, &toc_info, &service_error_code);
    TEST_print(services_handle,
               "** TEST %s error_code=%s TOC number = %d service_resp=0x%08X\n",
               p_test_name,
               SERVICES_error_to_string(error_code),
    ...
    for (each_toc = 0; each_toc < toc_info.number_of_toc_entries; each_toc++) {
        TEST_print(services_handle,
                   ...
                   version_string_pack((toc_info.toc_entry[each_toc].version >> 24) & 0xFF,
...
static uint32_t test_services_gettoc_version(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code = SERVICES_system_get_toc_version(services_handle, &version, &service_error_code);
...
static uint32_t test_services_get_se_revision(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code =
        SERVICES_get_se_revision(services_handle, (uint8_t *) &se_revision[0], &service_error_code);
    TEST_print(services_handle,
               "** TEST %s error_code=%s service_resp=0x%08X\n",
               p_test_name,
               SERVICES_error_to_string(error_code),
...
static uint32_t test_services_get_device_data(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code =
        SERVICES_system_get_device_data(services_handle, &device_data, &service_error_code);
    TEST_print(services_handle,
               "** TEST %s  error_code=%s service_resp=0x%08X\n",
               p_test_name,
               SERVICES_error_to_string(error_code),
    ...
    memcpy((uint8_t *) &print_buffer[0], device_data.ALIF_PN, sizeof(device_data.ALIF_PN));
    TEST_print(services_handle, "     ** ALIF_PN   %s\n", print_buffer);

    format_and_print((char *) &print_buffer[0], &device_data.HBK0[0], sizeof(device_data.HBK0));
    TEST_print(services_handle, "     ** HBK0      %s\n", print_buffer);

    format_and_print((char *) &print_buffer[0], &device_data.HBK1[0], sizeof(device_data.HBK1));
    TEST_print(services_handle, "     ** HBK1      %s\n", print_buffer);

    format_and_print((char *) &print_buffer[0], &device_data.HBK_FW[0], sizeof(device_data.HBK_FW));
    TEST_print(services_handle, "     ** HBK_FW    %s\n", print_buffer);

    format_and_print((char *) &print_buffer[0], &device_data.config[0], sizeof(device_data.config));
    TEST_print(services_handle, "     ** Wounding  %s\n", print_buffer);

    format_and_print((char *) &print_buffer[0],
                     &device_data.MfgData[0],
                     sizeof(device_data.MfgData));
    TEST_print(services_handle, "     ** MfgData   %s\n", print_buffer);

    format_and_print((char *) &print_buffer[0],
                     &device_data.SerialN[0],
                     sizeof(device_data.SerialN));
...
static uint32_t test_services_ewic_config(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code = SERVICES_power_ewic_config(services_handle, EWIC_RTC_SE | EWIC_RTC_A, OFF_PROFILE);
...
static uint32_t test_services_vbat_wakeup_config(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code = SERVICES_power_wakeup_config(services_handle, WE_SERTC | WE_LPRTC, OFF_PROFILE);
...
static uint32_t test_services_boot_toc_a32(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code = SERVICES_boot_process_toc_entry(services_handle, entry_id, &service_error_code);
...
static uint32_t test_services_boot_cpu(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code = SERVICES_boot_cpu(services_handle, cpu_id, address, &service_error_code);
...
static uint32_t test_services_boot_reset_cpu(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code = SERVICES_boot_reset_cpu(services_handle, cpu_id, &service_error_code);
...
static uint32_t test_services_boot_release_extsys0(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code = SERVICES_boot_release_cpu(services_handle, EXTSYS_0, &service_error_code);
...
static uint32_t test_services_mbedtls_aes(char *p_test_name, uint32_t services_handle)
{
    ...
    static const uint8_t IV[]    = {0x00,
                                    ...
                                    0x0E,
                                    0x0F};
    static const uint8_t PLAIN[] = {0x6B,
                                    0xC1,
                                    0xBE,
                                    0xE2,
                                    0x2E,
    ...
    static const uint8_t CYPHER[] = {0xDC,
                                     0x7E,
                                     0x84,
                                     0xBF,
                                     0xDA,
    ...
    SERVICES_cryptocell_mbedtls_aes_init(services_handle, &service_error_code, (uint32_t) aes_ctx);
    ...
    TEST_print(services_handle,
               "** TEST SERVICES_cryptocell_mbedtls_aes_init    error_code=%s "
               "service_resp=0x%08X\n",
               SERVICES_error_to_string(error_code),
               service_error_code);
    ...
    SERVICES_cryptocell_mbedtls_aes_set_key(services_handle,
                                            ...
                                            MBEDTLS_OP_ENCRYPT);
    TEST_print(services_handle,
               "** TEST SERVICES_cryptocell_mbedtls_aes_set_key error_code=%s "
               "service_resp=0x%08X\n",
               SERVICES_error_to_string(error_code),
               service_error_code);
    ...
    memcpy(iv, IV, sizeof(iv));
    TEST_print(services_handle,
               "** TEST SERVICES_cryptocell_mbedtls_aes_crypt   error_code=%s "
               "service_resp=0x%08X\n",
               SERVICES_error_to_string(error_code),
               service_error_code);
    // decrypt
...
static uint32_t test_services_bounds(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code = SERVICES_uart_write(services_handle, 0, (uint8_t *) &buffer[0]);
    TEST_print(services_handle,
               "** TEST %s error_code=%s\n",
               p_test_name,
               SERVICES_error_to_string(error_code));
    ...
    error_code =
        SERVICES_uart_write(services_handle, PRINT_BUFFER_SIZE + 1, (uint8_t *) &buffer[0]);
    TEST_print(services_handle,
               "** TEST %s error_code=%s\n",
               p_test_name,
               SERVICES_error_to_string(error_code));

    error_code = SERVICES_uart_write(services_handle, 20, (uint8_t *) NULL);
...
static uint32_t test_services_ospi_write_key(char *p_test_name, uint32_t services_handle)
{
    ...
    OSPI_WRITE_EXTERNAL_KEY_OSPI0,
    OSPI_WRITE_EXTERNAL_KEY_OSPI1
};
...
static uint32_t test_services_select_osc_source(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code =
        SERVICES_clocks_select_osc_source(services_handle,
...
static uint32_t test_services_xtal_is_started(char *p_test_name, uint32_t services_handle)
{
    ...
    bool is_started;
    error_code = SERVICES_pll_xtal_is_started(services_handle, &is_started, &service_error_code);
...
static uint32_t test_services_clkpll_is_locked(char *p_test_name, uint32_t services_handle)
{
    ...
    bool is_locked;
    error_code = SERVICES_pll_clkpll_is_locked(services_handle, &is_locked, &service_error_code);
...
static uint32_t test_services_pll_xtal(char *p_test_name, uint32_t services_handle)
{
    ...
    SERVICES_clocks_select_pll_source(services_handle,
                                      pll_source,
                                      PLL_TARGET_UART,
                                      &service_error_code);
    SERVICES_clocks_select_pll_source(services_handle,
    ...
    SERVICES_clocks_select_osc_source(services_handle,
                                      OSCILLATOR_SOURCE_RC,
                                      OSCILLATOR_TARGET_SYS_CLOCKS,
                                      &service_error_code);
    SERVICES_clocks_select_osc_source(services_handle,
                                      OSCILLATOR_SOURCE_RC,
...
static uint32_t test_services_boot_reset_soc(char *p_test_name, uint32_t services_handle)
{
  ...
  TEST_print(services_handle, "[%p] counter = %d, NEW pCounter->D[0] = %d)\n", pCounter, (int)counter, (int)pCounter->D[0]);
    ...
    if ((counter < 6) || (counter == 8)) {
        TEST_print(services_handle, "*** TEST %s counter = %d - reset SOC\n", p_test_name, counter);
...
static uint32_t test_services_cpu_boot_sequence(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code = SERVICES_boot_set_vtor(services_handle, EXTSYS_0, 0x80100000, &service_error_code);

    if (error_code == SERVICES_REQ_SUCCESS && service_error_code == SERVICE_SUCCESS) {
        error_code = SERVICES_boot_reset_cpu(services_handle, EXTSYS_0, &service_error_code);
    }
...
static uint32_t test_services_dcdc_voltage(char *p_test_name, uint32_t services_handle)
{
    ...
    TEST_print(services_handle,
               "dcdc voltage: dcdc_vout_sel=0x%x; "
               "dcdc_vout_trim=0x%x \n",
               dcdc_vout_sel,
               dcdc_vout_trim);
...
static uint32_t test_services_ldo_voltage(char *p_test_name, uint32_t services_handle)
{
    ...
    TEST_print(services_handle,
               "ldo voltage: ret_ldo_voltage=0x%x; "
...
static uint32_t test_services_get_bus_frequencies(char *p_test_name, uint32_t services_handle)
{
    ...
    error_code = SERVICES_clocks_setting_get(services_handle,
                                             ...
                                             &service_error_code);
    TEST_print(services_handle,
               "Invalid Clock Setting ID service_resp=0x%08X\n",
               service_error_code);
...
static uint32_t test_services_get_eui(char *p_test_name, uint32_t services_handle)
{
    ...
    uint8_t eui[5];
    error_code = SERVICES_system_get_eui_extension(services_handle, true, eui, &service_error_code);
    TEST_print(services_handle,
               "** TEST %s error_code=%s service_resp=0x%08X\n",
               p_test_name,
               SERVICES_error_to_string(error_code),
...
static uint32_t test_services_get_device_id(char *p_test_name, uint32_t services_handle)
{
    ...
    uint8_t device_id[8];
    error_code = SERVICES_system_get_device_id64(services_handle, device_id, &service_error_code);
    TEST_print(services_handle,
               "** TEST %s error_code=%s service_resp=0x%08X\n",
               p_test_name,
               SERVICES_error_to_string(error_code),
...
static uint32_t test_services_get_ecc_public_key(char *p_test_name, uint32_t services_handle)
{
    ...
    uint8_t ecc_key[64];
    error_code = SERVICES_system_get_ecc_public_key(services_handle, ecc_key, &service_error_code);
    TEST_print(services_handle,
               "** TEST %s error_code=%s service_resp=0x%08X\n",
               p_test_name,
               SERVICES_error_to_string(error_code),
